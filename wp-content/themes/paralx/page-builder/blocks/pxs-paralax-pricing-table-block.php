...
class PXS_Paralax_Pricing_Table_Block extends AQ_Block {

	function __construct() {
		$block_options = array(
			'name' => 'Paralax: Pricing Table',
			'size' => 'span12',
		);
		
		//create the widget
		parent::__construct('PXS_Paralax_Pricing_Table_Block', $block_options);
		
		//add ajax functions
		add_action('wp_ajax_aq_block_tbparalaxlist_add_new', array($this, 'add_table_paralax'));
	...
	function form($instance) {
		...
		<div class="description cf">
			...
			<p></p>
			<a href="#" rel="tbparalaxlist" class="aq-sortable-add-new button">Add New</a>
			<p></p>
		</div>
	...
	function block($instance) {
		...
		$out = '';
			...
			$out .= '<div class="paralax-table '.$ccss.'">';
		...
		$custom_css = " .paralax-table .tint.$ccss {
